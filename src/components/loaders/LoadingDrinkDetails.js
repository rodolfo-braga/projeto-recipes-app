...
function LoadingDrinkDetails() {
  ...
  return (
    ...
    >
      ...
      <rect x="18" y="255" rx="9" ry="9" width={ V_OITO } height="18" />
      <rect x={ X70 } y="220" rx="13" ry="13" width={ NOVE } height="26" />
      <rect x={ X83 } y="220" rx="13" ry="13" width={ NOVE } height="26" />
      <rect x="18" y="325" rx="10" ry="10" width={ UM_TERCO } height="20" />
      <rect x="18" y="356" rx="10" ry="10" width={ NOVENTA } height="100" />
      <rect x="18" y="480" rx="10" ry="10" width={ UM_TERCO } height="20" />
      <rect x="18" y="510" rx="10" ry="10" width={ NOVENTA } height="100" />
    </ContentLoader>
  );
}
